<div class="container-fluid">
    <div class="row">
        <div class="col-12 mb-3 mt-3">
            ...
            <div class="float-end">
                <a class="btn btn-success" id="btn_submit" href="#" onclick="submitEvaluation('html-css', 'tp3');"><i class="fa-solid fa-paper-plane"></i>&nbsp;Soumettre à validation</a>
            </div>
        </div>
        <div class="col-6" id="box_code">
            <div class="editor">
                ...
                <textarea id="code_editor" attr-extension="css" attr-module="html-css" attr-tp="tp3" spellcheck="false"></textarea>
            </div>
        </div>
