...
$title = " | Cours";
//die($_SESSION["intern"]["id_session"]);
ob_start();
...
<div class="container">
    <div class="row pt-5 courses">
        ...
        $sql_select_courses = "SELECT course_id, course_title, course_synopsis, course_link, course_illustration 
                                FROM courses c
				INNER JOIN courses_sessions cs ON (c.course_id = cs.id_course AND cs.id_session=:id_session)
                                WHERE course_session_active = 1
        ...
        $req_select_courses->bindParam(":id_session", $_SESSION["intern"]["id_session"]);
