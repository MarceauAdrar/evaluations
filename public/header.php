...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/eval/public/css/base.css" />
    ...
    <?php if(isset($_SESSION["intern"]["intern_id"])) { ?>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container-fluid">
                <a class="navbar-brand" href="http://localhost/eval/public">
                    <img src="http://localhost/eval/public/imgs/adrar_logo.svg" alt="Logo de l'ADRAR" id="logo_adrar" />
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarText">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="http://localhost/eval/public">Accueil</a>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbar_dropdown_modules">
                                <?php foreach($req_evaluations->fetchAll(PDO::FETCH_ASSOC) as $eval) { ?>
                                    <li><a class="dropdown-item" href="http://localhost/eval/public/modules/<?=$eval["evaluation_dd_link"]?>/"><?=$eval["evaluation_dd_name"]?></a></li>
                                <?php } ?>
                            </ul>
                        </li>
                    </ul>
                    <span class="navbar-text">
                        ...
                        &nbsp;
                        <a href="http://localhost/eval/public/logout.php">Se déconnecter</a>
                    </span>
                </div>
            </div>
        </nav>
