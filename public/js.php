        ...
        <script src="/public/js/consts.js" type="text/javascript"></script>
        <script src="/public/js/index.js" type="text/javascript"></script>
        <script src="/public/js/tooltips.js" type="text/javascript"></script>
        <script src="/public/js/modals.js" type="text/javascript"></script>