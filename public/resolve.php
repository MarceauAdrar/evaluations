                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-12" id="box_preview">
                            <iframe id="web_preview_full" src="http://' . $_SERVER["SERVER_ADDR"] . '/evaluations/public/stagiaires/' . $_SESSION["intern"]["intern_username"] . '/html-css/rando_nuit/index.html" frameborder="0"></iframe>
                        </div>
                    </div>
                </div>';
            break;
...
echo $html; 
include_once("./js.php"); ?>
<script src="/public/js/evals.js" type="text/javascript"></script>
